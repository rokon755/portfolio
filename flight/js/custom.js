...
/*====== home version 5 slider ========*/
	$('.home_owl-slide-here').owlCarousel({
		loop:true,
		nav: true,
		autoplay:true,
		autoplayTimeout:5000,
...
(function($) {
    ...
    $('.accordion a').click(function(j) {
        var dropDown = $(this).closest('li').find('.collapse_filter-section_content');

        $(this).closest('li').find('.collapse_filter-section_content').not(dropDown).slideUp();
