...
$('.magazine_main-slider_here').slick({
  centerMode: true,
  centerPadding: '60px',
  slidesToShow: 3,
  autoplay: true,
...
// smooth scroll page down
      $(document).ready(function(){
        $('.auto_bottom_scroll').click(function() {
...
$(window).scroll(function (){
	...
	//console.log(scroll);
	if(scroll >=144){
	  $(".mobile_responsive-menu").removeClass("mobile_responsive-menu").addClass("darkHeader")
	}else{
	  $(".darkHeader").removeClass("darkHeader").addClass("mobile_responsive-menu")
	}
});
